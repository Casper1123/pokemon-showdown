...
const SPEED_SETUP = [
	'agility', 'autotomize', 'flamecharge', 'rockpolish', 'snowscape', 'trailblaze', 'weavegarments',
];
...
const SETUP = [
	...
	'rockpolish', 'shellsmash', 'shiftgear', 'swordsdance', 'tailglow', 'takeheart', 'tidyup', 'trailblaze', 'workup', 'victorydance', 'weavegarments',
];
const SPEED_CONTROL = [
	'electroweb', 'glare', 'icywind', 'glaciate', 'lowsweep', 'nuzzle', 'quash', 'tailwind', 'thunderwave', 'trickroom', 'toxicthread',
];
...
const NO_STAB = [
	...
	'grassyglide', 'glaciate', 'iceshard', 'icywind', 'incinerate', 'infestation', 'machpunch', 'meteorbeam', 'mortalspin', 'nuzzle', 'pluck', 'pursuit',
...
const HAZARDS = [
	'spikes', 'stealthrock', 'stickyweb', 'toxicspikes', 'steelshards',
];
// Protect and its variants
const PROTECT_MOVES = [
	'banefulbunker', 'burningbulwark', 'protect', 'silktrap', 'spikyshield', 'timestop',
];
...
const PRIORITY_POKEMON = [
	'breloom', 'brutebonnet', 'cacturne', 'honchkrow', 'mimikyu', 'ragingbolt', 'scizor', 'golisopod', 'slitherwing', 'lokix', 'durant', 'golisopodmega',
];

/** Pokemon who should never be in the lead slot */
const NO_LEAD_POKEMON = [
	'Zacian', 'Zamazenta', 'Scolipede',
];
...
export class RandomTeams {
	...
	randomSets: { [species: string]: RandomTeamsTypes.RandomSpeciesData } = { ...require('./std_singles/OU.json'), ...require('./std_singles/UU.json') };
