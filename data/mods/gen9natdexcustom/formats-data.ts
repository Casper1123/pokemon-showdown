export const FormatsData: import('../../../sim/dex-species').SpeciesFormatsDataTable = {
	...
	// Fuck this bear. For now, at least. Let back in when Ubers arrive?
	urshifu: {
		tier: "Uber",
		doublesTier: "DUber",
		natDexTier: "Uber",
	...
	// endregion
	// region modded, non-doubles override pokemon
	// region gen1
	gengar: {
		tier: "RU",
		natDexTier: "MOD",
